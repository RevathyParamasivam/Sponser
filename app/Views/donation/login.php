...
<head>
  ...
  <title>GEMS - Sponser Profile</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Sponser Login</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" >
                    ...
                    <div class="col-12">
                      <button id="submit" class="btn btn-primary w-100" onclick="apiCall()" type="button">Login</button>
                    </div>
                   
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="NewSponser">Create an account</a></p>
                    </div>
                  </form>
