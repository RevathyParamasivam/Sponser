 ...
 <!-- ======= Footer ======= -->
            ...
            <div class="col-md-12" style="font-size: 15px;">
                <div class="block block-rounded block-fx-shadow">
                    <div class="block-content block-content-full">
                        <div class="js-validation-bootstrap alignCenter">
                                <div class="form-group row " style="background-color:#99BADD;margin-top:-20px;">
                                    <label class="col-lg-2 col-form-label" for="val-cause"><h5>Cause</h5></label>
                                    ...
                                    <label class="col-lg-4 col-form-label" for="val-remarks"><h5>Remarks</h5></label>
                                </div>
                                <form action="" method="post" id="new_sponsership_form">
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="val-general">General</label>
                                    <div class="col-lg-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-lg-2 col-form-label"></label>
                                    <label class="col-lg-2 col-form-label"></label>
                                    <label class="col-lg-4 col-form-label" >(If particular, kindly mention the purpose like Evangelism, Discipleship, Training, Medical, Welfare etc)</label>

                                </div>
                                
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="val-missionary">Missionary Support</label>
                                    <div class="col-lg-2">
                                    ...
                                    <label class="col-lg-4 col-form-label">(Single missionary Rs. 4000 per month)</label>
                                </div>
                                
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="val-child">Child Support</label>
                                    <div class="col-lg-2">
                                    ...
                                    <label class="col-lg-4 col-form-label">(Single child average Rs. 1500 per month - Any amount can be donated)</label>
                                </div>
                                
                                <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="val-church">Church Project</label>
                                    <div class="col-lg-2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-lg-2 col-form-label"></label>
                                    <label class="col-lg-2 col-form-label"></label>
                                    <label class="col-lg-4 col-form-label">(Church building is of 1000 sq ft and parsonage 500 sq ft @ Rs. 1000 per square feet. Land extra. Any amount can be donated. We will combine sponsors if needed)</label>     
                                </div>
                    ...
                    <div class="modal-footer">
                      ...
                      <button id="sponsership_submit" type="button" class="btn btn-primary">Submit</button>
                    </div>
                  </form>
                  </div>
                </div>
  ...
  <script src="boot\assests\js\apifunctions.js"></script>
   <script>
      $("#sponsership_submit").on("click", function(event){
      ...
      /* if(document.getElementById("child_amount").value!='')
       ...
       let child_monthly=document.getElementById("child_monthly"); 
        ...
        else
        {
            ...
            saveSponsershipDetails(apiData);
